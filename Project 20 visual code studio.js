...
function setup() {
  ...
  wall = Bodies.rectangle(300, 300, 70, 10, ground_options);
  World.add(world,wall);

  wall2 = Bodies.rectangle(80, 300, 70, 10, ground_options);
  World.add(world,wall2);
  
  wedge = Bodies.rectangle(200,150,100,20,ops);
  World.add(world,wedge);

  wedge2 = Bodies.rectangle(200,150,100,20,ops);
  World.add(world,wedge2);
  
  wedge3 = Bodies.rectangle(200,150,100,20,ops);
...
function draw() 
{
  ...
  rect(wall2.position.x,wall2.position.y,100,15);
